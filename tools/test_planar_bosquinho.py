# ========================================================
# PLAN B - TESTE SEGURO DE DECIMAÇÃO PLANAR: BOSQUINHO.GLB
...
model_name = "bosquinho.glb"
output_name = "bosquinho_teste_preview.glb"
...
print(f"Importando {input_path} (pode levar alguns segundos devido ao tamanho)...")
